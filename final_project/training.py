...
class TrainModel(luigi.Task):
    ...
    def run(self) -> None:
        ...
        self.model.save(join(abs_path, "..", "data", "models", f"model-{salted.get_salted_version(self)}"))
...
class BaseModel:
    ...
    def labels(self) -> dict:
        ...
        # class_indices = np.linspace(0, 1, self.num_classes)
...
class InceptionModel(BaseModel):
    ...
    def train(self, epochs=20, workers=6):
        """
        ...
        :param workers: int
        """
        return self.model.fit(self.training_generator, epochs=epochs, use_multiprocessing=True)
